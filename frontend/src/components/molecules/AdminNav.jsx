    ...
    <header className='relative z-10 h-fit'>
      <nav className='flex h-16 items-center justify-between px-8 drop-shadow-md'>
        ...
        <div className='group relative flex items-center'>
          ...
          <div className='absolute right-0 top-14 hidden w-60 max-w-sm rounded-lg border border-gray-200 bg-white py-10 opacity-0 shadow group-focus-within:block group-focus-within:opacity-100 dark:border-gray-700 dark:bg-gray-800'>
